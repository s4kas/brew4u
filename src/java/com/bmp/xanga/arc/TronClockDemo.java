...
public class TronClockDemo extends Application {
    ...
    public void start(final Stage primaryStage) {
        ...
        // create three clocks
        final IArc blueClock = new ArcClock(20, AbstractArc.BLUE1, AbstractArc.BLUE2, 200);
        final IArc greenClock = new ArcClock(20, AbstractArc.BLUE1, AbstractArc.GREEN1, 200);
        final IArc redClock = new ArcTemperature(20, AbstractArc.BLUE1, AbstractArc.RED1, 200);
